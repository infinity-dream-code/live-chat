        ...
        <div class="relative">
          <div class="inline-flex items-center justify-center w-20 h-20 bg-slate-700 rounded-2xl mb-5 shadow-lg pulse-subtle">
            <svg class="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a7 7 0 0114 0v1H3v-1z"></path>
            </svg>
          </div>

          <h1 class="text-3xl font-bold text-white mb-2 tracking-tight">LiveChat</h1>
          <p class="text-slate-300">Create your account to start chatting</p>
        </div>
      </div>
      ...
      <div class="p-8">
        ...
        <div class="mt-8 pt-8 border-t-2 border-slate-100">
          <p class="text-center text-sm text-slate-600">
            ...
            <a href="/login" class="font-bold text-slate-800 hover:text-slate-600 hover:underline transition ml-1">
              Sign in
            </a>
          </p>
        </div>
